...
class DIM(nn.Module):
    def __init__(self, scale,n_colors, conv=common.default_conv):
        ...
        self.fe_conv1 = common.BasicBlock(conv, n_colors, 196, kernel_size=3, bias=True, act=nn.PReLU())
        ...
        self.re_r = conv(96, n_colors, kernel_size=1)
