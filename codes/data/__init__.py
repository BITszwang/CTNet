...
def create_dataloaders(args):
    ...
    if args.dataset == 'AID':
        ...
        training_set = UCMercedDataset(args, root_dir='/media/wsz/FAB9B702EAEE0235/szwang/dataset/UCMerced_LandUse/split-train-val/train',
                                 train=True)
        val_set = UCMercedDataset(args, root_dir='/media/wsz/FAB9B702EAEE0235/szwang/dataset/UCMerced_LandUse/split-train-val/val',
                            train=False)
    ...
    dataloaders = {'train': DataLoader(training_set, batch_size=args.batch_size,
                                 shuffle=True, num_workers=6),  # args.n_threads
